...
const Signup = () => {
    ...
    const submitForm = async (event) => {
        ...
        await createUserWithEmailAndPassword(auth, `${formData.phone}@gmail.com`, formData.password)
            .then((userCredential) => {
                const obj = {
            ...
            <div className="flex min-h-screen flex-1 flex-col justify-center px-3 py-4 md:py-10 bg-gray-200">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <div className="text-center text-slate-500">
                        ...
                        <Link href="/signup" className="font-semibold inline-block text-green-500 ms-1">Sign in</Link>
                    </div>
                </div>
